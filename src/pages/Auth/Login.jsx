...
const LoginPage = () => {
    ...
    mutate(
      { email, password },
      {
        ...
        onError: () => {
          ...
          // Inline banner (stays until user edits a field)
  ...
  // Clear inline error as soon as user starts correcting input
      ...
      <div className={styles.loginCard}>
        ...
        <div className={styles.fieldGroup}>
          ...
          <div className={styles.fieldWrapper}>
            ...
            <div
              className={`${styles.inputWrapper} ${loginError ? styles.inputError : ""}`}
            >
              <span className={styles.inputIcon}>
                <MailIcon />
              </span>
